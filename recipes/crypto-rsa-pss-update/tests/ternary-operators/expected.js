...
const options2 = {
  modulusLength: 2048,
  hashAlgorithm: useStrong ? 'sha256' : 'sha1',
  mgf1HashAlgorithm: isDev ? 'sha1' : 'sha256'
};
...
const options3 = {
  hashAlgorithm: (isDev && 'sha1') || 'sha256',
  mgf1HashAlgorithm: useStrong && 'sha256'
};
...
crypto.generateKeyPairSync('rsa-pss', 
  isDev ? getHashOptions() : { hashAlgorithm: 'sha1' }
);