...
# DEP0130: `module.createRequireFromPath()` to `module.createRequire()`

Replaces the deprecated `createRequireFromPath` function with `createRequire` from `node:module`. Updates both the import/require declaration and all call sites, including aliased imports.
